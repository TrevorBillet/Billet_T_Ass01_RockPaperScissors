...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        do {
            do {
                System.out.println("Player One choose Rock, Paper, or Scissors [R,P, or S]");
                player1 = in.nextLine();
                ...
                if (player1.equals("R") || player1.equals("P") || player1.equals("S")) {
                    validMoveP1 = true;
                    do {
                        System.out.println("Player Two choose Rock, Paper, or Scissors [R,P, or S]");
                        player2 = in.nextLine();
            ...
            do {
                ...
                if (yesNo.equals("Y")) {
                    validYesNo = true;
                    playAgain = true;
                    System.out.println("Rerunning program, please wait.. ");
